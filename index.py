...
def create_widgets():
    ...
    root.logFrame = st.ScrolledText(root, wrap=tk.WORD, width=25, height=7, font=("Montserrat", 10)) 
    ...
    # clear Button
    root.GenerateBTN = CTkButton(root, text="Clear", command='', width=100, fg_color="gray", corner_radius=32)
    root.GenerateBTN.place(x=30, y=290)

    # generate Button
    root.GenerateBTN = CTkButton(root, text="Generate", command='', width=100, fg_color="green", corner_radius=32)
    root.GenerateBTN.place(x=30, y=320)
